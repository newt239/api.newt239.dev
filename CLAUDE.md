...
コミットメッセージは prefix つきで 1 行以内に簡潔に記述してください。詳細は [AGENTS.md](./AGENTS.md) を参照してください。

原則としてコード中にコメントは書かないでください。コードそのもので意図が伝わるように命名・構造化し、コメントに頼らないようにします。どうしても必要な場合のみ日本語で記述してください。
